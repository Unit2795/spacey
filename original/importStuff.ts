...
const objectExample = {key:{test:"hello world!"}, key2:"value2"}; // Object should have a space after the opening bracket and before the closing bracket, there should be a space after the colons
